...
export const constantRoutes = [
  ...
  // 学员管理
  {
    path: "/student",
    component: Layout,
    redirect: "/student/register-student-list",
    name: "Student",
    meta: { title: "学员管理", icon: "student" },
    children: [
      {
        path: "register-student-list",
        name: "register-student-list",
        component: () =>
          import("@/views/student-management/registered-student/index.vue"),
        meta: { title: "注册学员", icon: "list" },
      },
      // 学员档案 Student profile
      {
        ...
        component: () =>
          import(
            "@/views/student-management/registered-student/RegisterSudentProfile.vue"
          ),
        meta: { title: "学员档案", icon: "" },
      },
      // {
      //   path: "register-student-list",
      //   name: "register-student-list",
      ...
      {
        path: "read-member-list",
        name: "read-member-list",
        component: () =>
          import("@/views/student-management/read-member/index.vue"),
        meta: { title: "在读会员", icon: "list" },
      },
    ],
  },
